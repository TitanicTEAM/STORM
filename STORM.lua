...
kick(msg,msg.chat_id_,msg.sender_user_id_) 
stormmonshn(msg.chat_id_, msg.sender_user_id_, msg.id_, '📮¦ العضو » ( '..CatchName(data.first_name_,20)..' )\n📬¦ قام بالتكرار هنا وتم طرده \n' , 14, utf8.len(data.first_name_)) 
end
return false  
end 
if type == 'del' then 
...
addmod(msg.chat_id_) 
if ( data.member_count_ > tonumber(tahadevstorm:get(DEVSTOR..'setadd:bot'..bot_id) or 100) ) then
test = '*📮¦ تم تفعيــل المجموعه بـنجـاح 🍃\n📬¦ تم ترقية المنشئ والادمنيه *\n\nꪜ'
storm_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
tahadevstorm:sadd(DEVSTOR..'add:num'..msg.sender_user_id_,msg.chat_id_) 
tahadevstorm:set(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
tahadevstorm:sadd(DEVSTOR..'bot:gpsby:id', msg.chat_id_)   
...
test = '*📮¦ تم تعطيــل المجموعه بـنجـاح 🍃 *\n\nꪜ'
storm_sendMsg(msg.chat_id_, msg.id_, 1,test, 1, 'md')
tahadevstorm:del(DEVSTOR.."add:bot:group"..msg.chat_id_, true)  
...
tahadevstorm:sadd(DEVSTOR.."botgps", msg.chat_id_)  
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,tah)   tahadevstorm:set(DEVSTOR.."numgrop"..msg.chat_id_,tah.member_count_) end,nil) 
end
...
if tahadevstorm:get(DEVSTOR.."link:group"..ch) then
linkchl = tahadevstorm:get(DEVSTOR.."link:group"..ch)
...
'\n📬¦ My name is  ❪'..NAMEBOT..'❫'..
'\nـــــ🌸ــــ🌸ــــــ🌸ــــ🌸ـــــ🌸ــــــ🌸ـــــ🌸ـــــ🌸ـــــ🌸ـــــ🌸ــــ🌸ـــ'..
...
storm_sendMsg(msg.sender_user_id_, msg.id_, 1, '📬*¦* تم آرسـآل رسـآلتگ آلى آلمـطـور\n*📛¦* اشترك في قناة المطور \n*🚸¦* [اضغط هنا للدخول الى قناة](https://t.me/joinchat/AAAAAEQLtdQefQBS6tkhVA) \n', 1, "md")    
end     
...
local text = '📮¦ العضو ↫ ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم حظره من التواصل\n✓'
...
if text == "تحديث السورس 🔱" and is_devtaha(msg) then  storm_sendMsg(msg.chat_id_, msg.id_, 1, '♻ • جاري تحديث السورس • ♻', 1, 'md') os.execute('rm -rf STORM.lua') os.execute('wget https://raw.githubusercontent.com/TitanicTEAM/STORM/master/STORM.lua') sleep(0.5) storm_sendMsg(msg.chat_id_, msg.id_, 1, '🚸*¦* تم تحديث ♻ السورس ✔ ', 1, 'md') dofile('STORM.lua')  io.popen("rm -rf ~/.telegram-cli/data/audio/*") io.popen("rm -rf ~/.telegram-cli/data/document/*") io.popen("rm -rf ~/.telegram-cli/data/photo/*") io.popen("rm -rf ~/.telegram-cli/data/sticker/*") io.popen("rm -rf ~/.telegram-cli/data/temp/*") io.popen("rm -rf ~/.telegram-cli/data/thumb/*") io.popen("rm -rf ~/.telegram-cli/data/video/*") io.popen("rm -rf ~/.telegram-cli/data/voice/*") io.popen("rm -rf ~/.telegram-cli/data/profile_photo/*") end
...
if text == 'مسح المجموعات 💯' and is_devtaha(msg) then   local lgp = tahadevstorm:smembers(DEVSTOR.."bot:gpsby:id")   local lsug = tahadevstorm:smembers(DEVSTOR.."botgps")   local lgpn = tahadevstorm:scard(DEVSTOR.."bot:gpsby:id")   local lsugn = tahadevstorm:scard(DEVSTOR.."botgps") + tahadevstorm:scard(DEVSTOR.."bot:gpsby:id")   for k,v in pairs(lgp) do   rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   for k,v in pairs(lsug) do    rem_group(v)     changeChatMemberStatus(v, bot_id, "Left")    end   storm_sendMsg(msg.chat_id_, msg.id_, 1,"*📮¦* تم مغادره البوت من » ❪"..lsugn.."❫ مجموعات \n✓", 1, 'md')   end
...
monsend(msg,msg.chat_id_,'💥¦ اهلا عزيزي {'..get_rtba(msg)..'} 🍃\n📮¦ تم قفل الدردشه \n✓',msg.sender_user_id_)  
...
storm_sendMsg(msg.chat_id_, msg.id_,1, '*📮¦ العضو » ('..matches[2]..')\n📬¦ لا توجد صوره رقم » ('..matches[4]..') في حسابه *\n',1,'md') 
end 
end 
...
media = '{ متحركه ‹› ملصق ‹› صوره ‹› اغنيه ‹› بصمه ‹› اغنيه ‹› ملف ‹› فيديو }'
...
os.execute('wget https://raw.githubusercontent.com/TitanicTEAM/STORM/master/STORM.lua') 
sleep(0.5) 
...
if tonumber(kk.id_) == tonumber(113274401) then
t = 'مطور السورس'
...
if tonumber(iduser) == tonumber(113274401) then
t = 'مطور السورس'
...
if tonumber(result.sender_user_id_) == tonumber(113274401) then
t = 'مطور السورس'
...
if tonumber(tes.content_.entities_[0].user_id_) == tonumber(113274401) then
t = 'مطور السورس'
...
local lsugn = tahadevstorm:scard(DEVSTOR.."botgps") + tahadevstorm:scard(DEVSTOR.."bot:gpsby:id") 
...
if text == '5464564.' or text =='65465465.' or text=='يا 54654545' then
local text = [[
...
if data.username_ == false then
zo = '📮¦ العضو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ بالتاكيد تم طرده من الكروب\n🍃'   
...
if data.username_ == false then
setvip = '📮¦ العضو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تـرقيتـه مميز للـكروب\n🍃'   
...
if data.username_ == false then
setvips = '📮¦ العضو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تـرقيتـه مميز عام في البوت\n🍃'   
...
setvips = '*📮¦* العضو » ❪ [@'..username..'] ❫\n*📬¦ الايـدي » ❪* `'..result.id_..'` *❫*\n*🚸¦* تم تـرقيتـه مميز عام البوت'   
...
if data.username_ == false then
setmonsh = '📮¦ العضو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ تم تـرقيتـه منشئ للـكروب\n🍃'   
...
if data.username_ == false then
zo = '📮¦ العضو » ❪ '..CatchName(data.first_name_,15)..' ❫\n📬¦ بالتاكيد تم حظره عام من الكروب\n🍃'   
stormmonshn(msg.chat_id_, result.sender_user_id_, msg.id_, zo, 16, utf8.len(CatchName(data.first_name_,15)))   
tahadevstorm:sadd(DEVSTOR..'storm:gbaned',result.sender_user_id_)   
else
zo = '*📮¦* العضو » ❪ [@'..data.username_..'] ❫\n*📬¦ الايـدي » ❪* `'..result.sender_user_id_..'` ❫\n*🚸¦* بالتاكيد تم حظره عام من الكروب\n🍃'   
...
return false  end
if tahadevstorm:sismember(DEVSTOR..'lockpinmsg:ban'..msg.chat_id_,msg.sender_user_id_) then
storm_sendMsg(msg.chat_id_,msg.id_, 1, "*📮¦* تم منعك من التثبيت هنا لا تستطبع التثبيت \n🍃", 1, 'md')  
return false  end
local id = msg.id_ 
local msgs = {[0] = id}  
tdcli_function ({
...
if tonumber(msg.sender_user_id_) == tonumber(113274401) then
t = 'مطور السورس 🔱'
